...
* @Description: 通过神经网络训练分类模型，训练1个，输出为8元神经网络，输入向量为通过PCA降维
...
//		action.train();
	...
	public void clssifyRelation() {
		...
		try {
			...
			// 顺序读取概念特征向量
			List<double[]> listVectors = util.loadMatrix(ConstantValue.MODEL_PATH+domainName+"_2_reduce.txt");
	...
	public void train() throws IOException{
		...
		//4、顺序读取概念特征向量
		List<double[]> listVectors = conceptUtil.loadMatrix(ConstantValue.MODEL_PATH+"C19-Computer_2_reduce.txt");
